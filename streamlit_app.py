...
## fruit-list from an online document
...
streamlit.header('Breakfaxt Menu')
...
# create a function - call to a URL 
def get_fruityvice_data(this_fruit_choice):
  ...
  return fruityvice_normalized  # output it on the screen as a table
